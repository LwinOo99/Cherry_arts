    ...
    <header>
        <nav class="bg-white border-red-200 px-4 lg:px-6 py-2.5 dark:bg-red-800">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div id="login" class="flex items-center lg:order-2">
                    {{-- <a href="#"
                    ...
                    <div>
                        ...
                        <div id="dropdown"
                            ...
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                ...
                                <li>
                                    <a href="#"
                                        class="blockprofile block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Profile</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="blockprofile block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Orders</a>
                                </li>
                                <li>
                                    <a class="blockprofile block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                        href="{{ route('logout') }}"
